...
// Fetch all feedback
$feedback_stmt = $conn->prepare("SELECT * FROM citizen_feedback WHERE staff_id = :staff_id AND pin = 1 ORDER BY created_at DESC");
...
$feedback_stmt = $conn->prepare("SELECT *, pin AS isPinned, focus AS isFocused FROM citizen_feedback WHERE staff_id = :staff_id AND pin = 1 ORDER BY created_at DESC");
$feedback_stmt->bindParam(':staff_id', $staff_id);
$feedback_stmt->execute();
$feedbacks = $feedback_stmt->fetchAll(PDO::FETCH_ASSOC);
?>
  ...
  <div class="service_container">
    <div class="container">
        <div class="heading_container heading_center">
            <h2 style="color:white;">All Citizen Feedback <span>Pin</span></h2>
            <p style="color:white;">Here is the latest feedback from citizens.</p>
        </div>
      <div class="row">
