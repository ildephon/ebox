...
<section class="CitizenVoice_section layout_padding">
    <div class="container">
        <div class="heading_container heading_center">
            <h2>Insert New <span>Staff</span></h2>
            <p>Please provide the staff details to add them to your team.</p>
        </div>
        <hr>
        <div class="row">
            <div class="col-md-6">
            ...
            <form id="staffForm" action="add_staff_handler.php" method="post" enctype="multipart/form-data">
                <div class="row">
                    <!-- Staff Reader Name -->
